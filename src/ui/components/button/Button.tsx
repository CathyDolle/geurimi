...
export const buttonStyles = tv({
  ...
  variants: {
    ...
    variant: {
      ...
      header: [
        "text-40 lg:!text-16 transition-all duration-1000 hover:duration-100 ease-expo-out hover:opacity-80",
      ],
      alt: [
        ...shared,
        "bg-black text-white px-12 py-11 border border-black",
        "hover:bg-white hover:text-black",
      ],
      classicUnderlined: [
        "inline-flex underline uppercase text-11 font-reproMono",
      ],
      fade: [
        "transition-[color] !text-14 lg:!text-16 duration-1000 hover:duration-100 ease-expo-out overflow-visible",
      ],
      arrowHover: [
        "group relative text-white-60",
        "hover:text-white",
        "transition-all duration-1000 hover:duration-100 ease-expo-out",
      ],
      underlined: [
...
>(
  (
    ...
    const classNames = [
      buttonStyles({ ...props, variant, theme, active, disabled }),
      className,
